...
const TAGLINES = [
  ...
  'your buzzword density, scored by AI.',
  'the elite are invisible to you. for now.',
  'professional larping, taken seriously.',
  'your larp rating is the only metric that matters.',
]
        ...
        <div className={styles.card}>
          ...
          <div className={styles.confirmBox}>
            ...
            <p className={styles.confirmBody}>
              ...
              Click it to activate your account and begin the arc.
            </p>
            <button
  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.footer}>
        By joining you consent to having your larp rated by AI. It&apos;s giving terms of service.
      </p>
    </div>
  )
}
